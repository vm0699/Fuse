...
const datingOptions = ["Long-term relationship", "Short-term relationship", "New friends", "Open to exploring", "Marriage", "Not sure yet"];
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Dating Intentions</Text>
